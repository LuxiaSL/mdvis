...
We create a dependency graph (graph LR) where an edge from
Module A to Module B indicates that A imports B.
"""
...
def generate_global_dependency_diagram(modules: List[Module]) -> str:
    ...
    Each node represents a module, and an edge from A to B indicates that A imports B.
