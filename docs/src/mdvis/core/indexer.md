...
title: indexer
type: module
file_path: /home/luxia/projects/mdvis/src/mdvis/core/indexer.py
package: mdvis.core
stats:
  classes: 1
  functions: 1
...
### Classes
- [[#class-indexbuilder|IndexBuilder]]

### Functions
- [[#function-build-cross-reference-index|build_cross_reference_index]]
...
- **import** `logging`
- **from** `models.elements` **import** [[elements#class-module|Module]], [[elements#class-class|Class]], [[elements#class-function|Function]], [[elements#class-importstatement|ImportStatement]]
- **from** `models.index` **import** [[index#class-crossreferenceindex|CrossReferenceIndex]], [[index#class-elementref|ElementRef]], [[index#class-importresolution|ImportResolution]], [[index#class-typeresolution|TypeResolution]], [[index#class-callresolution|CallResolution]], [[index#class-dependencyedge|DependencyEdge]], [[index#class-referencetype|ReferenceType]], [[index#class-eventflow|EventFlow]]
...
**Returns:** [[index#class-crossreferenceindex|CrossReferenceIndex]]
